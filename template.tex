...
\fancyfoot[R]{\footnotesize \addfontfeature{Color=lightgray}Modified from Lucy D'Agostino McGowan's  RMarkdown, inspired by the LaTeX \href{http://www.latextemplates.com/template/friggeri-resume-cv}{Friggeri} template.}
...
$endif$
$if(attributes3)$
\section{hats I've worn}
$attributes3$
$endif$
\end{aside}

\section{Marine Data Scientist}
\vspace{-0.25cm}
$interests$
...
\vspace{-0.5cm}
\section{Data Science Content and Trainings}
\vspace{-0.25cm}
$for(edu2)$
    \textbf{$edu2.degree$} $edu2.description_1$ \fn{$edu2.where$}\\
    $if(edu2.description_2)$ 
     $edu2.description_2$\\
     $endif$ \\
$endfor$
